...
_COMPLETION_CLAIM_RE = re.compile(
    ...
    r"\b(?:consider(?:s|ed|ing)?|deem(?:s|ed|ing)?|declar(?:e|es|ed|ing)|"
    r"call(?:s|ed|ing)?|regard(?:s|ed|ing)?|view(?:s|ed|ing)?|"
    r"judg(?:e|es|ed|ing)|certif(?:y|ies|ied|ying)|pronounc(?:e|es|ed|ing)|"
    r"assess(?:es|ed|ing)?|believ(?:e|es|ed|ing)|find(?:s|ing)?|found)\s+"
